...
with open(DATA_PATH+'weights/xgbmodel5.pkl','wb') as f:
    pickle.dump(xgb,f)
...
print(submit.head())
submit.to_csv(DATA_PATH + 'submit/submit_xgb5.csv', index=False)
...
print(score) # 1.450721075604466

# 스크류 삽입 깊이 outlier 제거
# submit_xgb5.csv 제출해봐
# 1.9539371776

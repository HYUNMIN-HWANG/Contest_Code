...
with open(DATA_PATH+'weights/xgbmodel7.pkl','wb') as f:
    pickle.dump(xgb,f)
...
with open(DATA_PATH+'weights/xgbmodel7-2.pkl','wb') as f:
    pickle.dump(xgb2,f)
...
print(submit.head())
submit.to_csv(DATA_PATH + 'submit/submit_xgb7.csv', index=False)
...
print(score) 
# 1.352123577634516 epoch 200 결과. 이전 결과와 똑같음 근데 역시나  overfitting일 수도 있다. 

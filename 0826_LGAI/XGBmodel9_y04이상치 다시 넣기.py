...
with open(DATA_PATH+'weights/xgbmodel9.pkl','wb') as f:
    pickle.dump(xgb,f)
...
with open(DATA_PATH+'weights/xgbmodel9-2.pkl','wb') as f:
    pickle.dump(xgb2,f)
...
print(submit.head())
submit.to_csv(DATA_PATH + 'submit/submit_xgb9.csv', index=False)

...
with open(DATA_PATH+'weights/xgbmodel6.pkl','wb') as f:
    pickle.dump(xgb,f)
...
print(submit.head())
submit.to_csv(DATA_PATH + 'submit/submit_xgb6.csv', index=False)
...
print(score) # 1.352123577634516

# submit_xgb6.csv epoch 200 으로 했더니 score가 좋아지기는 하는데 overfitting일 것 같다.
# 일단 제출해봐
# 1.9758262299	
# overfitting임
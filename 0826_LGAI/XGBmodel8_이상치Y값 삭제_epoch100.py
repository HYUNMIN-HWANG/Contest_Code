...
with open(DATA_PATH+'weights/xgbmodel8_100.pkl','wb') as f:
    pickle.dump(xgb,f)
...
with open(DATA_PATH+'weights/xgbmodel8-2_100.pkl','wb') as f:
    pickle.dump(xgb2,f)
...
print(submit.head())
submit.to_csv(DATA_PATH + 'submit/submit_xgb8_100.csv', index=False)

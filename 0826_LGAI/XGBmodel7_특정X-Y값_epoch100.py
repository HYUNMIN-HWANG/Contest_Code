...
with open(DATA_PATH+'weights/xgbmodel7_100.pkl','wb') as f:
    pickle.dump(xgb,f)
...
with open(DATA_PATH+'weights/xgbmodel7-2_100.pkl','wb') as f:
    pickle.dump(xgb2,f)
...
print(submit.head())
submit.to_csv(DATA_PATH + 'submit/submit_xgb7_100.csv', index=False)

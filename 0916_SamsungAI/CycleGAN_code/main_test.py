...
parser.add_argument("--ckpt_dir", default="D:\\Data\\3D_Metrology\\SEM_cyclegan\\checkpoints_bc16", type=str, dest="ckpt_dir")
parser.add_argument("--log_dir", default="D:\\Data\\3D_Metrology\\SEM_cyclegan\\log_tensorboard_bc16", type=str, dest="log_dir")
parser.add_argument("--result_dir", default="D:\\Data\\3D_Metrology\\SEM_cyclegan\\log_result_bc16", type=str, dest="result_dir")

...
parser.add_argument("--mode", default="train_SIM", choices=["train", "test","train_SIM"], type=str, dest="mode")
...
parser.add_argument("--data_dir", default="D:\\Data\\3D_Metrology\\simulation_data", type=str, dest="data_dir")

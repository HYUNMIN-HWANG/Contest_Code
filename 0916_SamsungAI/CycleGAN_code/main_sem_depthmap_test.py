...
parser.add_argument("--mode", default="test_sem_depth", choices=["train", "test", "train_sem_depth", "test_sem_depth"], type=str, dest="mode")
...
parser.add_argument("--data_dir", default="D:\\Data\\3D_Metrology\\test\\SEM", type=str, dest="data_dir")
parser.add_argument("--ckpt_dir", default="D:\\Data\\3D_Metrology\\SEM_cyclegan\\checkpoints_sem_depth", type=str, dest="ckpt_dir")
parser.add_argument("--log_dir", default="D:\\Data\\3D_Metrology\\SEM_cyclegan\\log_tensorboard_sem_depth", type=str, dest="log_dir")
parser.add_argument("--result_dir", default="D:\\Data\\3D_Metrology\\SEM_cyclegan\\log_result_sem_depth", type=str, dest="result_dir")
...
if __name__ == "__main__":
    if args.mode == "train" or args.mode == "train_sem_depth" :
        train(args)
    elif args.mode == "test" or args.mode == "test_sem_depth" :
        test(args)
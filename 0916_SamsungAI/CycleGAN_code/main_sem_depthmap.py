...
parser.add_argument("--mode", default="train_sem_depth", choices=["train", "test", "train_sem_depth"], type=str, dest="mode")
...
parser.add_argument("--data_dir", default="D:\\Data\\3D_Metrology\\train", type=str, dest="data_dir")

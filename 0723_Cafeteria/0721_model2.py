...
lunch_cat = CatBoostRegressor(**ctb_params, verbose = None, logging_level = 'Silent')
dinner_cat = CatBoostRegressor(**ctb_params, verbose = None, logging_level = 'Silent')
...
final_submission.to_csv('../data/DACON/cafeteria_prediction/sub/0721_submit2.csv', index=False)
print(final_submission.shape)   # (50, 3)
print(final_submission.head())
#            일자          중식계         석식계
# 0  2021-01-27   997.153738  418.705748
# 1  2021-01-28   941.176151  447.752665
# 2  2021-01-29   574.382579  259.869734
# 3  2021-02-01  1116.637966  461.383058
# 4  2021-02-02   984.470876  566.744232
